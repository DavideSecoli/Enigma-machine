...
from plugboard_rnd import Plugboard
...
class EnigmaSimulator:
    ...
    @classmethod
    def input_parameters(cls, rotors=None, ring_settings=None, reflector=None, plugboard_settings=None, seed=None):
        ...
        seed:  0-N integer used to feed pseudo-random number generator for plugboard pairs
        """
        ...
        return cls(ensembled_rotors,
                   ...
                   Plugboard.pluglead_pairs(plugboard_settings, seed))

    def starting_position(self, initial_position):
        """Sets rotor initial position
